...
Json2xml.prototype._transform = function (unit, encoding, callback) {
	...
	for (var properties in unit) {
		if (typeof unit[properties] ==='undefined' || unit[properties] === '' || unit[properties] === null) continue;
		if (unit[properties] instanceof Array && unit[properties].length === 0) continue;
		xml.push('\t<'+properties+'>');
